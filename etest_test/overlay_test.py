...
class TestRoot:
    ...
    def test_nonempty_from_file(self, overlay: pathlib.Path) -> None:
        """Test root discovery of a non-empty overlay from a file."""
        assert sut.root(overlay / "metadata" / "layout.conf") == overlay  # nosec
